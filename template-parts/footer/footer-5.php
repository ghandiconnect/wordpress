...
?>
<footer id="footer" class="footer footer-5 text-center <?php echo esc_attr($iqconnetik_footer_background . ' ' . $iqconnetik_font_size . ' ' . $iqconnetik_background_image['class']); ?>" <?php echo (!empty($iqconnetik_background_image['url'])) ? 'style="background-image: url(' . esc_url($iqconnetik_background_image['url']) . ');"' : ''; ?>>
	<?php
	...
	<div class="container<?php echo esc_attr($iqconnetik_fluid . ' ' . $iqconnetik_extra_padding_top . ' ' . $iqconnetik_extra_padding_bottom); ?>">
		...
		?>
		<div class="layout-cols-1 <?php echo esc_attr('layout-gap-' . $iqconnetik_footer_layout_gap); ?>">
