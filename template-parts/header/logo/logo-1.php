...
if (is_page_template('page-templates/home.php')) :
	iqconnetik_option('header_background') === 'i';
endif;
?>
<<?php echo esc_html($div); ?> class="logo logo-left <?php echo esc_attr($iqconnetik_logo_image_class . ' ' . $iqconnetik_logo_background . ' ' . $iqconnetik_logo_padding_class); ?>" href="<?php echo esc_url(home_url('/')); ?>" rel="home" itemprop="url">
	<?php
	//image
