...
$iqconnetik_logo_white          = (!empty(iqconnetik_option('logo_image_inverse'))) ? iqconnetik_option('logo_image_inverse') : '';
...
?>
<<?php echo esc_html($div); ?> class="logo logo-between <?php echo esc_attr($iqconnetik_logo_image_class . ' ' . $iqconnetik_logo_background . ' ' . $iqconnetik_logo_padding_class); ?>" href="<?php echo esc_url(home_url('/')); ?>" rel="home" itemprop="url">
	...
	//image
	if (iqconnetik_option('header_background') === 'l' || iqconnetik_option('header_background') === 'l m' || iqconnetik_option('header_background') === '') :
	...
	if (!empty($iqconnetik_logo_text_secondary)) :
		?>
