...
?>
<div id="overlay"></div>
<header id="header" class="page_header_side header_side_right header-5 <?php echo esc_attr($iqconnetik_header_background . ' ' . $iqconnetik_font_size . ' ' . $iqconnetik_transparent); ?>">
