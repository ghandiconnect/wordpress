...
<div class="grid-item">
	<article id="post-<?php the_ID(); ?>" <?php post_class('vertical-item with_shadow'); ?> itemtype="https://schema.org/Article" itemscope="itemscope">
		...
		<div class="item-content content-padding">
			...
			<?php if (get_the_title()) : ?>
				<header class="entry-header">
					...
					if (
						...
						|| !empty(iqconnetik_option('blog_show_tags')) && !empty(get_the_tags())
						...
						<div class="entry-meta post-meta greylinks">
							<?php iqconnetik_entry_meta(false, true, false, true, true, true, true); ?>
						</div>
					<?php endif; ?>
					<?php
			...
			?>
			<div class="entry-content greylinks" itemprop="text">
				<?php
				the_content(
			...
			<?php
			if (!empty(iqconnetik_option('blog_show_author'))) : ?>
				<footer class="entry-footer entry-footer-top">
					<div class="entry-meta post-meta darklinks">
						<?php iqconnetik_entry_meta(true, false, false, false, false, false, false); ?>
					</div><!-- .entry-meta -->
