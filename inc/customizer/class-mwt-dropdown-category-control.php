...
if (!class_exists('Iqconnetik_Dropdown_Category_Control') && class_exists('WP_Customize_Control')) :

	class Iqconnetik_Dropdown_Category_Control extends WP_Customize_Control
	{
