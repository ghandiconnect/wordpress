...
//all Google fonts
if (!function_exists('iqconnetik_get_google_fonts_array')) :
	function iqconnetik_get_google_fonts_array()
	{
		return apply_filters(
			'iqconnetik_google_fonts_array',
			array(
				''                               => array(
					'family'   => '',
					'category' => '',
...
//Get fonts names
if (!function_exists('iqconnetik_get_google_fonts_array_keys')) :
	function iqconnetik_get_google_fonts_array_keys()
	{
		$iqconnetik_fonts = iqconnetik_get_google_fonts_array();
		$iqconnetik_r     = array(
			'' => esc_html__('Inherit', 'iqconnetik'),
		);
		foreach ($iqconnetik_fonts as $iqconnetik_name => $iqconnetik_font_options) {
			$iqconnetik_r[$iqconnetik_name] = $iqconnetik_name;
		}
...
//Get font variants
if (!function_exists('iqconnetik_get_google_font_properties')) :
	function iqconnetik_get_google_font_properties($iqconnetik_name = '', $iqconnetik_property = 'variants')
	{
		$iqconnetik_r = array();
		if (empty($iqconnetik_name)) {
			return $iqconnetik_r;
		}
		$iqconnetik_fonts = iqconnetik_get_google_fonts_array();
		if (!empty($iqconnetik_fonts[$iqconnetik_name][$iqconnetik_property])) {
			foreach ($iqconnetik_fonts[$iqconnetik_name][$iqconnetik_property] as $iqconnetik_prop) {
				$iqconnetik_r[$iqconnetik_prop] = $iqconnetik_prop;
			}
		}
